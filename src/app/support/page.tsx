...
export const metadata: Metadata = {
  title: "Support — Somnia",
};

export default function Support() {
  return (
    <LegalPage title="Somnia — Support">
      <p>Welcome to Somnia support. We&apos;re here to help!</p>
      ...
      <p>Tap the <strong>+</strong> button on the home screen. You can either type your dream or tap the microphone icon to record your voice. Somnia will automatically transcribe and analyze your dream.</p>
      ...
      <p>Yes. All your dream data is stored locally on your device. Only the content you submit for AI analysis is sent to our AI provider (Google Gemini) for processing. We do not store your data on any servers. See our <a href="/somnia-app/privacy-policy">Privacy Policy</a> for full details.</p>
      ...
      <ol>
        ...
        <li>Make sure you are running the latest version of Somnia and iOS.</li>
      ...
      <p>
        ...
        <strong>GitHub Issues</strong>: <a href="https://github.com/buraka/somnia-app/issues">github.com/buraka/somnia-app/issues</a>
      </p>
